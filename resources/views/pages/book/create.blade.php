    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="card shadow card-primary">
                ...
                <div class="card-body">
                    <form action="#" method="POST" id="form_tambah_buku" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" cols="30" rows="10" style="height: 200px !important;"></textarea>
...
@push('script')
    <script>
        $("#form_tambah_buku").submit(function(e) {
            e.preventDefault();
